...
function peg$parse(input, options) {
  ...
  const peg$e4 = peg$classExpectation(["s", "m", "h", "d"], false, false, false);
  ...
  function peg$f3(int, qual) {return int*qual  }
  function peg$f4(ident) {var key = ident.flat().join(""); return options[key] || 0  }
